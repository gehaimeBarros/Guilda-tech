...
function setValue() {
    var nome = document.getElementById('value').value;
    document.getElementById('textNome').value = nome;
};

function setValueMeta() {
    var nome = document.getElementById('value-semana').value;
    document.getElementById('textNome-semana').value = nome;
};

function setValueAtigindo() {
    var nome = document.getElementById('value-atingido-one').value;
    document.getElementById('textNome-atingido').value = nome;
};
...
function progbar(instance) {
    ...
    instance.innerHTML =
        `<div class="prog-bar"></div><div class="prog-percent">0%</div>`;
